...
def imprime(lc, lv, i = 1): #i = 1 porque não preciso que ele percorra nos brancos
    """
...
def main():
    ...
    if v >= c:
        ...
        listav = [0] * (c + 2) #quando a lista dos candidatos é maior que a de votos eu preciso faazer uma lista maior,
        #  para conseguir acessar ela facilmente
    vt = votantes(listav[:], v, c)
